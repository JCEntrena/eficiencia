...
Hemos creado un makefile.
Hemos escrito código en bash para generar las gráficas.
Hemos reescrito partes del código para que sea legible.
Hemos cambiado la medición de tiempo, por una más precisa.
