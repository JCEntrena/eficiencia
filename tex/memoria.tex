...
necesarios al guión y de redirigir la salida al archivo correcto, de forma que el usuario solo debe ejecutar órdenes del tipo \texttt{make plot} o \texttt{make fit}
para generar gráficas de datos y de ajuste, respectivamente, de todos los programas.
...
\imagen{../regressionPlots/seleccion_fit.jpg}{Ordenación por selección}
...
es posible que la eficiencia práctica no se corresponda con la teórica.
