...
\subsection{Algoritmos teóricamente $\mathcal{O}(n^2)$}
 ...
 El mejor ajuste práctico de los probados es de la forma $ax^3+bx^2+cx+d$,
  ...
  $$f(n)=-3.91702\cdot 10^{-14} \cdot n^3+2.20218\cdot 10^{-9}\cdot n^2-1.39687 \cdot 10^{-6}\cdot n+0.00102057$$
...
\subsection{Algoritmos teóricamente $\mathcal{O}(nlog(n)$}
  ...
  El mejor ajuste práctico ha resultado ser: 
  $$f(n)=-4.52927\cdot 10^{-16} \cdot n^3+8.28261\cdot 10^{-12}\cdot n^2+1.13041 \cdot 10^{-7}\cdot n-
  1.72007\cdot 10^{-6}$$ 
  ...
  \cdot 10^{-6}log(n)-3.42946 \cdot 10^{-6}$$
  con una media de residuos cuadráticos de $7.02599 \cdot 10^{-6}$\\
