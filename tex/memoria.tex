...
\subsection{Algoritmos teóricamente $\mathcal{O}(n^2)$}
  ...
  El ajuste que deberíamos haber obtenido era de la forma: $f(n) = a \cdot n^2+b \cdot n+c$\\
  El mejor ajuste práctico ha resultado ser el de la forma $ax^3+bx^2+cx+d$,
  con una media de residuos cuadráticos de $0.0037376$. \\
    ...
    $f(n)=4.0846\cdot 10^{-5}\cdot n \cdot log(n)-0.000353425\cdot n +0.0204474 \cdot log(n)-0.0654402$ & $0.00767502$ \\ \hline
