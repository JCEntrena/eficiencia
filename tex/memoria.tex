...
Además, para la generación de dichas gráficas, hemos escrito un guion en \texttt{bash} que usa 
...
\subsection {Gráficas}
\begin{multicols}{2} % Esto no funciona...?
...
\section{Apéndice: Listados de código}
...
\newpage
\section{Apéndice: Guion generador de datos y gráficos}
\label{gengraf}
...
Se adjuntan las tablas generadas
